...
#' genes in 'x'. Default is \code{MaizeGeneFamilies::all.cds}.
...
#' Default is 'codeml', use option 'MaizeGeneFamilies.codeml.call' to set another
#' default.
#'
...
computeKsPipeline <- function(gene.a, gene.b, cds = all.cds, t.d = file.path(tempdir(), 
    paste(gene.a, gene.b, sep = "_")), codeml.call = getOption("MaizeGeneFamilies.codeml.call", 
    "codeml")) {
    if (!file.exists(t.d)) 
